-- SHOPORA Phase 1 initial schema
-- Foundation tables: users, businesses, business_staff, roles, permissions, role_permissions
...
-- CreateIndex
CREATE INDEX "BusinessStaff_roleId_idx" ON "BusinessStaff"("roleId");

-- CreateIndex
CREATE UNIQUE INDEX "BusinessStaff_userId_businessId_roleId_key" ON "BusinessStaff"("userId", "businessId", "roleId");
...
-- AddForeignKey
ALTER TABLE "BusinessStaff" ADD CONSTRAINT "BusinessStaff_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "Role"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
